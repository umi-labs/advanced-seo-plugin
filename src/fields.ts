  ...
  admin: {
    components: {
      Field: {
        ...
        path: '@foundrykit/advanced-seo-plugin/client#OverviewComponent',
      },
    },
  },
})
  ...
  admin: {
    components: {
      Field: {
        ...
        path: '@foundrykit/advanced-seo-plugin/client#MetaTitleComponent',
      },
    },
  },
  ...
  admin: {
    components: {
      Field: {
        ...
        path: '@foundrykit/advanced-seo-plugin/client#MetaDescriptionComponent',
      },
    },
  },
  ...
  admin: {
    components: {
      Field: {
        ...
        path: '@foundrykit/advanced-seo-plugin/client#PreviewComponent',
      },
...
export const MetaJsonLdField = (opts: MetaJsonLdFieldOptions = {}): import('payload').JSONField => ({
  ...
  admin: {
    components: {
      Field: '@foundrykit/advanced-seo-plugin/client#JsonLdEditorComponent',
    },
  },
